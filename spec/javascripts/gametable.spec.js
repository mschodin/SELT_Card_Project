...
test('Check that GameTable exists', () => {
    ...
    const test_url = "__pile_id__"
    const { getAllByRole, getByText, getByLabelText, getByTestId} = render(<GameRoom handId={0} playerHand={test_hand} piles={test_piles} players={test_players} create_deck_urls={test_url} />);
